...
const draggableComponent = defineComponent({
  ...
  render() {
    try {
      this.error = false;
      const { $slots, $attrs, tag, componentData, realList, getKey,componentSlots } = this;
      ...
      return componentStructure.render(h, attributes,componentSlots);
    } catch (err) {
      this.error = true;
